...
/**
 * TRiwayatHarga form base class.
 *
 * @method TRiwayatHarga getObject() Returns the current form's model object
 *
 * @package    properti
 * @subpackage form
 ...
 */
abstract class BaseTRiwayatHargaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('t_riwayat_harga[%s]');
