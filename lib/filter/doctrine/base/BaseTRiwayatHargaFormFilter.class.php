...
/**
 * TRiwayatHarga filter form base class.
 *
 * @package    properti
 * @subpackage filter
 ...
 */
abstract class BaseTRiwayatHargaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('t_riwayat_harga_filters[%s]');
